# SkeView: Skeleton Ground Truth of Existing Shape and Image Datasets

SkeView is an annotation tool based on the theory of [diagnosticity hypothesis](http://www.ai.mit.edu/projects/dm/Tversky-features.pdf) (Amos Tversky, 1977) for shape and image skeletons. Based on SkeView, we annotate high-quality skeleton Ground Truth (GT) for 17 existing shape and image datasets.
- Image datasets:
  - **SK506**: SK506 (also known as SK-SMALL) was selected from the MS COCO dataset, with 506 natural images (300 for training and 206 for testing) and 16 object classes, including humans, animals, and artifacts. (Shen et al. IEEE CVPR 2016)
